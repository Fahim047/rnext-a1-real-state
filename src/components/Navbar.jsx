						...
						<ul className="hidden lg:flex ">
							{navLinks.map((link) => (
								<li key={link} className="group relative">
									<a
										href={`#${link}`}
										className="ud-menu-scroll capitalize mx-8 flex py-2 text-base font-medium text-dark group-hover:text-primary dark:text-white lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70"
									>
										{link}
									</a>
								</li>
